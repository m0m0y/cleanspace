                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                        <tr>
                            <td style="background-color:#FFFFFF;color:#000000;padding:20px;">
                                <center><img alt="CleanSpace" src="../assets/img/logo.png" width="150" style="display: block;" /></center>
                            </td>
                        </tr>
                    </table>
                            ...
                            <td style="padding:20px;background-color:#F8F7F0;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">'.$purchase_price.'</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">Serial Nuber:</td>
                        ...
                        <tr>
                            <td style="padding:20px;background-color:#F8F7F0;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                                        ...
                                        <tr>
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">'.$radio.'</td>
                                        </tr>
