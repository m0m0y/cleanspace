...
class Test {
    public function emailMessage($name, $contact, $email, $message) {
       $mail = '
       <!DOCTYPE html>
        <html>
        <head>
                        ...
                        <tr>
                            <td style="padding:20px;background-color:;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                                        <thead>
                                        <tr>
                                            <th scope="col" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;line-height:30px;text-align:left;">Name: '.$name.'</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">Email: '.$email.'</td>
                                        </tr>
                                        <tr>
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">Phone: '.$contact.'</td>
                                        </tr>
                                        <tr>
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">Message: '.$message.'</td>
                                        </tr>
                                        </tbody>
                                    </table>
